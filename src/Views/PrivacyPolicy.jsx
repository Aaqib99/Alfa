    ...
    <>
      ...
      <div className="w-full p-4 md:p-24">
        ...
        <ul
          ...
          style={{ color: "#20376D" }}
        >
          <li className="font-medium text-2xl">Customer</li>
          <p className="text-lg mt-4" style={{ color: "#20376D" }}>
        ...
        <ul
          ...
          style={{ color: "#20376D" }}
        >
          <li className="font-medium text-2xl">Device</li>
          <p className="text-lg mt-4" style={{ color: "#20376D" }}>
        ...
        <ul
          ...
          style={{ color: "#20376D" }}
        >
          <li className="font-medium text-2xl">IP Address</li>
          <p className="text-lg mt-4" style={{ color: "#20376D" }}>
        ...
        <ul
          ...
          style={{ color: "#20376D" }}
        >
          <li className="font-medium text-2xl">Personnel</li>
          <p className="text-lg mt-4" style={{ color: "#20376D" }}>
        ...
        <ul
          ...
          style={{ color: "#20376D" }}
        >
          <li className="font-medium text-2xl">Personal Data</li>
          <p className="text-lg mt-4" style={{ color: "#20376D" }}>
        ...
        >
          ...
          <li className="text-lg font-bold mt-4">Name / Username</li>
          <li className="text-lg font-bold mt-4">Phone Numbers</li>
          <li className="text-lg font-bold mt-4">Email Addresses</li>
          <li className="text-lg font-bold mt-4">Mailing Addresses</li>
        </ul>
        <ul
          className="list-disc text-lg mt-4 list-inside text-sm space-y-1"
          style={{ color: "#20376D" }}
        ...
        <p className="text-lg font-bold mt-4" style={{ color: "#20376D" }}>
